...
class ClaudeService:
    ...
    def _parse_claude_response(self, response_text: str, form_data: Dict[str, Any]) -> AnalysisResponse:
        ...
        try:
            ...
            # Combine root cause explanations for Google Sheets logging
            root_cause_explanation = ""
            if primary_cause.get("simple_explanation"):
                root_cause_explanation = primary_cause.get("simple_explanation", "")
            if secondary_cause.get("simple_explanation"):
                if root_cause_explanation:
                    root_cause_explanation += "\n\n" + secondary_cause.get("simple_explanation", "")
                else:
                    root_cause_explanation = secondary_cause.get("simple_explanation", "")

            # Extract treatment explanation for Google Sheets logging
            treatment_explanation = treatment.get("explanation_for_patient", "")
