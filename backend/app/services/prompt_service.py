...
class PromptService:
    ...
    def _build_complete_prompt(self, components: Dict[str, str]) -> str:
        ...
        prompt_parts = [
            ...
            '    "simple_term": "2-4 word simple label in plain English/Hinglish (e.g., \'Performance anxiety\', \'Weak pelvic muscles\', \'Diabetes nerve issue\')",',
            ...
            '    "simple_term": "2-4 word simple label (e.g., \'Overactive stress response\', \'Porn-related issue\')",',
