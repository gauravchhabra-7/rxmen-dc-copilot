...
class AnalysisResponse(BaseModel):
    ...
    # Explanations for Google Sheets logging
    root_cause_explanation: Optional[str] = Field(None, description="Combined explanation of root causes in Hinglish for agent to read to patient")
    treatment_explanation: Optional[str] = Field(None, description="Treatment explanation in Hinglish for agent to read to patient")
